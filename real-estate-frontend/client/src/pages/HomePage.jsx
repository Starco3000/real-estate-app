...
function HomePage() {
  const { latestPosts, topPosts } = useLoaderData();
          ...
          <div className='w-full max-w-[860px] h-auto bg-white flex flex-col items-end '>
            ...
            <div className='flex flex-row gap-7'>
              ...
              <ul className='w-full h-full flex flex-col '>
                {/** When render, change at li first:pb-[14px] last:pt-[14px] */}
                <li className='w-full h-auto py-[14px] hover:bg-gray-100'>
                  <Link to='#' className='line-clamp-2 overflow-hidden'>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Mollitia autem inventore, officiis quis fuga ipsum
                    voluptatibus unde tenetur esse nesciunt.{' '}
                  </Link>
                </li>
                <li className='w-full h-auto py-[14px] hover:bg-gray-100'>
                  <Link to='#' className='line-clamp-2 overflow-hidden'>
